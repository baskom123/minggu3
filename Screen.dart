...
import 'package:flutter_application_3/m03/HistoryProvider.dart';
import 'package:flutter_application_3/m03/HistoryScreen.dart';
import 'package:flutter_application_3/m03/ItemScreen.dart';
import 'package:flutter_application_3/m03/MyProvider.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Color.fromARGB(2, 182, 247, 5),
        actions: <Widget>[
          IconButton(
